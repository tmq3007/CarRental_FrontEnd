...
export default function MyCarDetailsPage() {
    const params = useParams();
    const carId = params.carId ;
    //console.log("carId", String(carId))
    const { data: carDetail, isLoading, error } = useGetCarDetailQuery(String(carId));
            ...
            <div className="max-w-6xl mx-auto ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <CarImageCarousel
                        images={carImages}
                        alt={carInfo.name}
                        className="w-full h-52" // or whatever dimensions you prefer
                    />
